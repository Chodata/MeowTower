...
//{
//	
//	RenderWindow window(VideoMode(512, 512), "ABC", Style::Close | Style::Resize);
//	RectangleShape player(Vector2f(100.0,150.0f));
//	//player.setFillColor(Color::Red);
//	player.setOrigin(50, 50);
//	player.setPosition(206, 206);
//
//	View view(Vector2f(0.0, 0.0), Vector2f(512, 512));
//
...
//
//
//	Vector2u TextureSize = playerTexture.getSize();  //u for unsign integer
//	TextureSize.x /= 3;
//	TextureSize.y /= 9;
//
